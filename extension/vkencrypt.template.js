...
(function() {
    ...
    // === 🔑 Статические ключи (редактируйте в коде) ===
    // По умолчанию совпадают с bot/.env (PRE_SHARED_KEY_K1..K4).
    // build.sh подставляет реальные значения из ../bot/.env при сборке,
    // либо отредактируйте этот блок вручную.
    const STATIC_KEYS = {
