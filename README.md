...
Реальная работа шифрования в чате ВКонтакте: текст уходит в виде `ENC[k1:...]`, на принимающей стороне расширение подставляет расшифровку с переключателем `[шифр]/[текст]`.

<video src="docs/media/IMG_9299.MP4" controls width="100%"></video>

[Скачать/открыть оригинал](docs/media/IMG_9299.MP4)
