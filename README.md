...
В поле ввода в чате появятся две иконки:

- **🔒** — нажал, и сообщение превращается в шифр. Отправляешь как обычно.
- **🔑** — выбор ключа. По умолчанию работает, но можешь завести свой.
